"""Tests for ai-match-v1 configuration."""
import os
import importlib
...
class TestSettingsDefaults:
    ...
    def test_default_service_name(self):
        ...
        s = Settings()
        assert s.service_name == "ai-match-v1"
    ...
    def test_settings_singleton_exists(self):
        ...
        assert settings.service_name == "ai-match-v1"

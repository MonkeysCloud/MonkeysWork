<?php
/**PATH /app/www/resources/views/components/ui/feature-card.ml.php ENDPATH**/
use MonkeysLegion\Template\Support\AttributeBag;
$cardClass = $highlight ? 'feature-card feature-card-highlight' : 'feature-card';
?>

<div class="<?= \MonkeysLegion\Template\Support\Escaper::attr( $cardClass ) ?>">
...
<?php if (isset($title) && $title): ?>
        <h3 class="feature-title"><?= \MonkeysLegion\Template\Support\Escaper::html($title) ?></h3>
<?php endif; ?>
<?php if (isset($description) && $description): ?>
        <p class="feature-description"><?= \MonkeysLegion\Template\Support\Escaper::html($description) ?></p>
<?php endif; ?>
<?php if (isset($link) && $link): ?>
        <a href="<?= \MonkeysLegion\Template\Support\Escaper::attr( $link ) ?>" class="feature-link">
            Learn more

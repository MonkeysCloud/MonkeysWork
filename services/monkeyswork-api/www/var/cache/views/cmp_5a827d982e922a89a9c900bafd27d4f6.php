<?php
/**PATH /app/www/resources/views/components/ui/navbar.ml.php ENDPATH**/
    ...
    <div class="navbar-container">
        ...
        <div class="navbar-brand">
            <a href="/" class="navbar-logo">
                <img src="<?= \MonkeysLegion\Template\Support\Escaper::attr( $logo ) ?>" alt="MonkeysLegion" height="40">
            </a>
        </div>

        
        <div class="navbar-menu" id="navbar-menu">
            <a href="/" class="<?= \MonkeysLegion\Template\Support\AttributeBag::conditional(['navbar-link', 'active' => $currentPage === 'home']) ?>">Home</a>
            ...
            <?= \MonkeysLegion\Template\Support\Escaper::html($menu ?? '') ?>
        </div>

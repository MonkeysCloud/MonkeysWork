<?php
/**PATH /app/www/resources/views/components/ui/footer.ml.php ENDPATH**/
...
<footer <?= (string)($attrs->merge(['class' => 'footer']) ?? '') ?>>
    <div class="footer-container">
        <div class="footer-grid">
            
            <div class="footer-brand">
                <img src="<?= \MonkeysLegion\Template\Support\Escaper::attr( $logo ) ?>" alt="MonkeysLegion" height="40" class="footer-logo">
        ...
        <div class="footer-bottom">
            <p class="footer-copyright">
                &copy; <?= \MonkeysLegion\Template\Support\Escaper::html($year) ?> MonkeysLegion. Built with ❤️ by the community.
            </p>

...
export const metadata: Metadata = {
    title: "Terms of Service — MonkeysWorks",
    description: "MonkeysWorks Terms of Service governing use of our AI-powered freelance marketplace.",
};
...
Fee Changes: MonkeysWorks reserves the right to modify fee rates with 30 days' prior notice. Existing active Contracts will not be affected by fee increases until their completion.
...
All fees are non-refundable except as required by applicable law or as explicitly stated in our Dispute Resolution process. By using the Platform, you acknowledge and agree to pay all applicable fees associated with your transactions.`,
    },
    {
        ...
        content: `Fixed-Price Contracts: Clients fund milestone escrow before work begins. Funds are released to the Freelancer upon Client acceptance or after the 14-day auto-acceptance period. Hourly Contracts: Clients are billed weekly based on tracked hours. Time tracking is verified through our monitoring tools. Refunds: Disputed payments are handled through our Dispute Resolution process. MonkeysWorks may hold funds during investigation. Withdrawal: Freelancers may withdraw earned funds to their verified payment method. Processing times vary by method and region.`,
    },
    {
        id: "ip",
        title: "8. Intellectual Property",
        content: `Work Product: Unless otherwise agreed in the Contract, all intellectual property rights in work product transfer to the Client upon full payment. Pre-Existing IP: Freelancers retain rights to their pre-existing tools, frameworks, and methodologies. They grant Clients a non-exclusive license to use such materials as part of the deliverables. Platform Content: All MonkeysWorks branding, design, software, and content are owned by MonkeysCloud LLC. Users may not copy, modify, or distribute Platform content without written permission. User Content: You retain ownership of content you upload (profiles, portfolios, reviews). You grant MonkeysWorks a worldwide, non-exclusive license to display, distribute, and use such content for Platform operations and marketing.`,
    },
    {
        id: "conduct",
...
Step 2 — Platform Mediation: If direct resolution fails, either party may file a formal dispute. MonkeysWorks will assign a mediator who will review evidence from both parties, including the Contract terms, communication records, delivered work, and any supporting documentation.

Step 3 — Binding Decision: If mediation does not result in agreement, MonkeysWorks will issue a binding decision regarding escrowed funds within 14 business days. This decision is final and non-appealable with respect to escrowed funds.
    ...
    return (
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
            ...
            <div style={{
                ...
                (&quot;MonkeysWorks&quot;). Please read them carefully before using our platform.
            </div>
            ...
            <div style={{
                ...
                ⚠️ <strong>Important:</strong> By creating an account, you acknowledge that MonkeysWorks is a{" "}

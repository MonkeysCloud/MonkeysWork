...
export default function FreelancerRegisterForm() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            // Success — redirect to success / onboarding
    ...
    return (
        <section className="min-h-[calc(100vh-72px)] flex">
            ...
            <div className="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-brand-dark via-[#2a2b3d] to-brand-dark relative overflow-hidden">
                {/* glow effects */}
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[400px] h-[250px] bg-emerald-500/10 rounded-full blur-[100px]" />
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
                    ...
                    <p className="mt-5 text-white/40 leading-relaxed max-w-sm">
                        Get matched with high-quality projects that fit your
                        skills. Set your rate, build your reputation, and get
                        paid securely.
                    </p>
                    ...
                    <div className="mt-10 space-y-4">
                        {[
                            { icon: "🎯", text: "AI matches you with relevant projects" },
                            { icon: "💰", text: "Milestone-based payments, always protected" },
                            { icon: "📈", text: "Build verified reputation with each project" },
                        ].map((item) => (
            ...
            <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12 sm:py-16 bg-brand-surface">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {/* primary skill + hourly rate side by side */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {/* primary skill */}
                            <div>
                                <label htmlFor="primarySkill" className="block text-xs font-semibold text-brand-muted mb-1.5">
                                    Primary Skill
                                </label>
                                <select
                                    id="primarySkill"
                                    ...
                                    className={`${inputCls("primarySkill")} bg-white`}
                                >
                                ...
                                {fieldErrors.primarySkill && <p className="mt-1 text-xs text-red-500">{fieldErrors.primarySkill}</p>}
                            </div>

                            {/* hourly rate */}
                            <div>
                                <label htmlFor="hourlyRate" className="block text-xs font-semibold text-brand-muted mb-1.5">
                                    Hourly Rate
                                </label>
                                <div className="relative">
                                    <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-brand-muted text-sm">$</span>
                                    <input
                                        id="hourlyRate"
                                        type="number"
                                        min="1"
                                    ...
                                    />
                                    <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-brand-muted text-xs">/hr</span>
                                </div>
                            </div>
                        </div>
